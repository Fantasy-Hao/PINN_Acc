...
class PhysicsInformedNN():
    ...
    def __init__(self, x, y, t, u, v, p, layers):
        ...
        self.loss_log_name = f'../logs/2_fixed_{current_time}'
...
if __name__ == "__main__":
    ...
    torch.save(model.dnn.state_dict(), '../checkpoints/2_fixed.pth')
    print("Model saved.")
    ...
    plot_solution(X_star, u_pred, 1, "fixed_u_pred.png")
    plot_solution(X_star, v_pred, 2, "fixed_v_pred.png")
    plot_solution(X_star, p_pred, 3, "fixed_p_pred.png")

    plot_solution(X_star, u_star - u_pred, 4, "fixed_u_error.png")
    plot_solution(X_star, v_star - v_pred, 5, "fixed_v_error.png")
    plot_solution(X_star, p_star - p_pred, 6, "fixed_p_error.png")
