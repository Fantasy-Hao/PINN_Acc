...
class PhysicsInformedNN():
    ...
    def __init__(self, x, y, t, u, v, p, layers):
        ...
        self.loss_log_name = f'../logs/7_SA_{current_time}'
    ...
    def loss_func(self):
        ...
        loss = torch.mean((self.w_u * (u_pred - self.u)) ** 2) + \
               ...
               torch.mean((self.w_f_u * f_u_pred) ** 2) + \
               torch.mean((self.w_f_v * f_v_pred) ** 2)
...
if __name__ == "__main__":
    ...
    torch.save(model.dnn.state_dict(), '../checkpoints/7_SA.pth')
    print("Model saved.")
    ...
    plot_solution(X_star, u_pred, 1, "sa_u_pred.png")
    plot_solution(X_star, v_pred, 2, "sa_v_pred.png")
    plot_solution(X_star, p_pred, 3, "sa_p_pred.png")

    plot_solution(X_star, u_star - u_pred, 4, "sa_u_error.png")
    plot_solution(X_star, v_star - v_pred, 5, "sa_v_error.png")
    plot_solution(X_star, p_star - p_pred, 6, "sa_p_error.png")
