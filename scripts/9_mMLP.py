...
class PhysicsInformedNN():
    ...
    def __init__(self, x, y, t, u, v, p, layers):
        ...
        self.loss_log_name = f'../logs/9_mMLP_{current_time}'
...
if __name__ == "__main__":
    ...
    torch.save(model.dnn.state_dict(), '../checkpoints/9_mMLP.pth')
    print("Model saved.")
    ...
    plot_solution(X_star, u_pred, 1, "mmlp_u_pred.png")
    plot_solution(X_star, v_pred, 2, "mmlp_v_pred.png")
    plot_solution(X_star, p_pred, 3, "mmlp_p_pred.png")

    plot_solution(X_star, u_star - u_pred, 4, "mmlp_u_error.png")
    plot_solution(X_star, v_star - v_pred, 5, "mmlp_v_error.png")
    plot_solution(X_star, p_star - p_pred, 6, "mmlp_p_error.png")
