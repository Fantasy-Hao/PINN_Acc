...
class PhysicsInformedNN():
    ...
    def __init__(self, x, y, t, u, v, p, layers):
        ...
        self.loss_log_name = f'../logs/6_R3_{current_time}'
...
if __name__ == "__main__":
    ...
    torch.save(model.dnn.state_dict(), '../checkpoints/6_R3.pth')
    print("Model saved.")
    ...
    plot_solution(X_star, u_pred, 1, "r3_u_pred.png")
    plot_solution(X_star, v_pred, 2, "r3_v_pred.png")
    plot_solution(X_star, p_pred, 3, "r3_p_pred.png")

    plot_solution(X_star, u_star - u_pred, 4, "r3_u_error.png")
    plot_solution(X_star, v_star - v_pred, 5, "r3_v_error.png")
    plot_solution(X_star, p_star - p_pred, 6, "r3_p_error.png")
