...
class PhysicsInformedNN():
    ...
    def __init__(self, x, y, t, u, v, p, layers):
        ...
        self.loss_log_name = f'../logs/1_pinn_{current_time}'
...
if __name__ == "__main__":
    ...
    torch.save(model.dnn.state_dict(), '../checkpoints/1_pinn.pth')
    print("Model saved.")
    ...
    plot_solution(X_star, u_star, 1, "u_star.png")
    plot_solution(X_star, v_star, 2, "v_star.png")
    plot_solution(X_star, p_star, 3, "p_star.png")

    plot_solution(X_star, u_pred, 4, "pinn_u_pred.png")
    plot_solution(X_star, v_pred, 5, "pinn_v_pred.png")
    plot_solution(X_star, p_pred, 6, "pinn_p_pred.png")

    plot_solution(X_star, u_star - u_pred, 7, "pinn_u_error.png")
    plot_solution(X_star, v_star - v_pred, 8, "pinn_v_error.png")
    plot_solution(X_star, p_star - p_pred, 9, "pinn_p_error.png")
