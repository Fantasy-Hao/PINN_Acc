...
class PhysicsInformedNN():
    ...
    def __init__(self, x, y, t, u, v, p, layers):
        ...
        self.loss_log_name = f'../logs/10_SA+RBA_{current_time}'
    ...
    def loss_func(self):
        ...
        loss = torch.mean((self.w_u * (u_pred - self.u)) ** 2) + \
               ...
               torch.mean((self.w_f_u * self.lambda_u * f_u_pred) ** 2) + \
               torch.mean((self.w_f_v * self.lambda_v * f_v_pred) ** 2)
...
if __name__ == "__main__":
    ...
    torch.save(model.dnn.state_dict(), '../checkpoints/10_SA+RBA.pth')
    print("Model saved.")
    ...
    plot_solution(X_star, u_pred, 1, "sa+rba_u_pred.png")
    plot_solution(X_star, v_pred, 2, "sa+rba_v_pred.png")
    plot_solution(X_star, p_pred, 3, "sa+rba_p_pred.png")

    plot_solution(X_star, u_star - u_pred, 4, "sa+rba_u_error.png")
    plot_solution(X_star, v_star - v_pred, 5, "sa+rba_v_error.png")
    plot_solution(X_star, p_star - p_pred, 6, "sa+rba_p_error.png")
